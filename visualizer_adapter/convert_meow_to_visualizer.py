...
class ConvertMeowToVisualizer:
    ...
    @staticmethod
    def event_to_base_struct (event) -> VISUALIZER_STRUCT :
    ...
    @staticmethod
    def meow_job_to_visualizer_struct (job) -> VISUALIZER_STRUCT :
        event = job[JOB_EVENT]
        result = ConvertMeowToVisualizer.event_to_base_struct(event)
